...
| Command | Behaviour |
|---|---|
| `/search <query>` | Content search via `GET /api/search`. Paginated hit list with a client-generated snippet and client-side ranking — the API returns neither. |
...
## 5. LLM operations on existing notes (P6)
...
## 6. Reliability and operations (P5, P7)
